export const translations = {
  en: {
    ...
    rojoEmptyWarningTitle: "Project has almost no scripts",
    rojoEmptyWarningBody: "Connecting Rojo to an existing Roblox place may delete its content in Studio — Rojo treats your local files as the source of truth. Import your existing game first, or start from a fresh place.",
  ...
  ko: {
    ...
    rojoError: "오류",
    startServing: "서빙 시작",
    rojoEmptyWarningTitle: "스크립트가 거의 없는 프로젝트",
    rojoEmptyWarningBody: "기존 Roblox 플레이스에 Rojo를 연결하면 Studio의 내용이 삭제될 수 있습니다. Rojo는 로컬 파일을 원본으로 간주합니다. 기존 게임을 먼저 가져오거나, 새 플레이스로 시작하세요.",
    clearLogs: "로그 지우기",
    tools: "도구",
    formatAll: "전체 포맷",
    lintAll: "전체 린트",
