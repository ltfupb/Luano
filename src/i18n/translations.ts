export const translations = {
  en: {
    ...
    crashReportsPromptBody: "Send anonymous crash reports so we can fix bugs faster. Stack traces only — no code, no file contents, no personal info. You can change this anytime in Settings.",
  ...
  ko: {
    ...
    crashReportsPromptBody: "익명 크래시 리포트를 보내면 버그를 더 빨리 고칠 수 있습니다. 스택 트레이스만 — 코드/파일 내용/개인 정보는 전송 안 됨. Settings에서 언제든 변경 가능합니다.",
