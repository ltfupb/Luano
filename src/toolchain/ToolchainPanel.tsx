...
export function ToolchainPanel({ onClose }: ToolchainPanelProps): JSX.Element {
  ...
  return (
    <div
      ...
      style={{
        background: `rgba(5,8,15,${visible ? "0.8" : "0"})`,
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 flex overflow-hidden">
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ background: "var(--bg-base)", border: "1px solid var(--border-subtle)", fontSize: "14px" }}
                    >
            ...
            {detail && (
              ...
              >
                <div className="flex items-center gap-2">
                  <span style={{ fontSize: "16px" }}>{CATEGORY_ICONS[detail.category] ?? ""}</span>
